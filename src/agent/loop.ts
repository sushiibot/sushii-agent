...
- When a fetched message shows "[image: filename.ext](url)" and you need to assess its content, immediately call \`inspect_image\` with that url — don't ask first. You can pass multiple image_urls at once.
