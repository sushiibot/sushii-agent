...
// u:/c:/t:/e:/msg: tokens and none of Discord's **bold**/__underline__ syntax. It keeps the shared
// brain (memory, web_search, ops-triage) while speaking like a normal Slack participant.
...
- You have persistent memory (read_memory/write_memory) scoped to this workspace and can search the web. Use them when they help; don't announce that you're using a tool.
