// Parity tests: assert the NEW parseElements/buildComponentMessages reproduce the goldens
// pinned in characterization/delivery.characterization.test.ts.
import { describe, expect, test } from "bun:test";
import type { ContainerBuilder } from "discord.js";
import { buildComponentMessages, parseElements } from "./delivery.ts";
